...
/// @brief pide al usuario que ingrese el codigo del vuelo
///
/// @param flycode, puntero que devuelve el codigo de vuelo ingresado
/// @param mensaje, mensaje que donde se imprime la peticion
void pedirFlyCode(char flyCode[10], char* mensaje);
/// @brief le pide usuario un dato a traves de string y cambia el ultimo bit de '\n' a '\0'
///
/// @param cadena puntero por donde se devuelve el string obtenido
/// @param longitud tamaño del string
/// @return devuelve -1 si hubo un error - 0 si esta todo bien
int myGets(char *cadena, int longitud);
/// @brief transforma el string obtenido de esUnNumero y myGets a un entero
///
/// @param pResultado puntero por donde se devuelve el entero obtenido
/// @return devuelve -1 si hubo un error en esta funcion o en alguna de las anteriores - 0 si esta todo bien
int getInt(int *pResultado);
/// @brief recorre el string para verificar que todos sean numeros
///
...
/// @brief pide al usuario que ingrese un numero entero usando getInt, verifica que este dentro de los parametros establecidos
/// 	   y devuelve el entero ingresado
///
...
/// @return devuelve -1 si hubo un error - 0
int utn_getInt(int *pResultado, char *mensaje, char *mensajeError, int minimo, int maximo);
/// @brief pide al usuario que ingrese un numero flotante usando getFloat, verifica que este dentro de los parametros establecidos
/// 	   y devuelve el flotante generado
///
/// @param pResultado puntero por el cual devuelve el flotante ingresado
/// @param mensaje mensaje que se imprime para pedir el dato al usuario
...
/// 	   que no sean letras y devuelve el nombre ingresado
///
